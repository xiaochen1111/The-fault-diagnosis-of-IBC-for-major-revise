...
% Load the Data
clc
N   = 201741:1:1211227;%360001322870
...
%% Plot for sbuSection C 1 load variation 100 4 to 8
figure(7)
subplot(411)
plt = plot(t,Duty_Cycle);
color = 'o';
Picture_LCF;
ylabel("(a) Duty cycle",'FontSize',15,'LineWidth',12);
subplot(412)
color = '';
PPP = 1;
plt = plot (T,Is1_Int);
...
%% Plot for sbuSection C 2 Input voltage  10 to 14
figure(7)
subplot(411)
plt = plot(t,Duty_Cycle);
color = 'o';
...
legend("CI_{P1}","CI_{P2}","CI_{P3}")
set(gcf,'position',[0 0 600 500])
%% Plot for sbuSection C 3 variation of the inductor
figure(6)
subplot(311)
color = '';
PPP = 1;
...
ylabel("(a) I_{L}(A)",'FontSize',15,'LineWidth',12);
subplot(312)
plt = plot(T,Max_difference);
color = 'p';
Picture_LCF;
...
%% Plot for sbuSection C 3 variation of the inductor2
figure(6)
subplot(411)
color = '';
PPP = 1;
