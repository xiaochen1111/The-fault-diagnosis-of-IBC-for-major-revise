...
#include <math.h>
#include "C_fault_detection_under_varing_load_acc.h"
#include "C_fault_detection_under_varing_load_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T
C_fault_detection_under_varing_load_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T
...
return ( true ) ; } real_T
C_fault_detection_under_varing_load_acc_rt_TDelayInterpolate ( real_T
...
void C_fault_detection_under_varing_load_SampleIL1_Init ( SimStruct * S ,
B_SampleIL1_C_fault_detection_under_varing_load_T * localB ,
P_SampleIL1_C_fault_detection_under_varing_load_T * localP ) { localB ->
B_1_0_0 = localP -> P_0 ; } void
C_fault_detection_under_varing_load_SampleIL1 ( SimStruct * S , boolean_T
rtu_Trigger , real_T rtu_In ,
B_SampleIL1_C_fault_detection_under_varing_load_T * localB ,
DW_SampleIL1_C_fault_detection_under_varing_load_T * localDW ,
ZCE_SampleIL1_C_fault_detection_under_varing_load_T * localZCE ) { if (
...
} } void C_fault_detection_under_varing_load_SampleIL1_Term ( SimStruct *
const S ) { } static void mdlOutputs ( SimStruct * S , int_T tid ) { real_T *
lastU ; real_T rtb_B_6_25_0 ; real_T rtb_B_6_2_0 ; boolean_T rtb_B_6_64_0 ;
boolean_T rtb_B_6_63_0 ; int32_T isHit ;
B_C_fault_detection_under_varing_load_T * _rtB ;
P_C_fault_detection_under_varing_load_T * _rtP ;
X_C_fault_detection_under_varing_load_T * _rtX ;
PrevZCX_C_fault_detection_under_varing_load_T * _rtZCE ;
DW_C_fault_detection_under_varing_load_T * _rtDW ; _rtDW = ( (
DW_C_fault_detection_under_varing_load_T * ) ssGetRootDWork ( S ) ) ; _rtZCE
= ( ( PrevZCX_C_fault_detection_under_varing_load_T * ) _ssGetPrevZCSigState
( S ) ) ; _rtX = ( ( X_C_fault_detection_under_varing_load_T * )
ssGetContStates ( S ) ) ; _rtP = ( ( P_C_fault_detection_under_varing_load_T
* ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_C_fault_detection_under_varing_load_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB
...
-> B_6_10_0 = _rtP -> P_62 * _rtB -> B_6_9_0 [ 16 ] ; ssCallAccelRunBlock ( S
, 6 , 11 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_6_12_0 = _rtP -> P_63 * _rtB ->
B_6_9_0 [ 15 ] ; ssCallAccelRunBlock ( S , 6 , 13 , SS_CALL_MDL_OUTPUTS ) ;
_rtB -> B_6_14_0 = _rtP -> P_64 * _rtB -> B_6_9_0 [ 17 ] ;
...
B_6_22_0 <= C_fault_detection_under_varing_load_rtC ( S ) -> B_6_3_0 ) ; }
_rtB -> B_6_23_0 = _rtDW -> Compare_Mode ;
C_fault_detection_under_varing_load_SampleIL1 ( S , _rtB -> B_6_23_0 , _rtB
-> B_6_16_0 , & _rtB -> SampleIL4 , & _rtDW -> SampleIL4 , & _rtZCE ->
...
= _rtP -> P_70 * _rtB -> B_6_9_0 [ 12 ] ; } isHit = ssIsSampleHit ( S , 1 , 0
) ; if ( isHit != 0 ) { C_fault_detection_under_varing_load_SampleIL1 ( S ,
_rtB -> B_6_23_0 , _rtB -> B_6_29_0 , & _rtB -> SampleIL1 , & _rtDW ->
SampleIL1 , & _rtZCE -> SampleIL1 ) ; } _rtB -> B_6_31_0 = _rtB -> B_6_28_0 -
_rtB -> SampleIL1 . B_1_0_0 ; _rtB -> B_6_33_0 = _rtX -> Integrator_CSTATE_m
; _rtB -> B_6_34_0 = _rtP -> P_71 * _rtB -> B_6_31_0 + _rtB -> B_6_33_0 ; if
( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Saturation_MODE = _rtB ->
B_6_34_0 >= _rtP -> P_73 ? 1 : _rtB -> B_6_34_0 > _rtP -> P_74 ? 0 : - 1 ; }
_rtB -> B_6_35_0 = _rtDW -> Saturation_MODE == 1 ? _rtP -> P_73 : _rtDW ->
Saturation_MODE == - 1 ? _rtP -> P_74 : _rtB -> B_6_34_0 ; isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( ssIsMajorTimeStep ( S
) != 0 ) { _rtDW -> RelationalOperator_Mode = ( _rtB -> B_6_35_0 > _rtB ->
B_6_21_0 ) ; } _rtB -> B_6_36_0 = _rtDW -> RelationalOperator_Mode ;
C_fault_detection_under_varing_load_SampleIL1 ( S , _rtB -> B_6_23_0 , _rtB
...
C_fault_detection_under_varing_load_acc_rt_TDelayInterpolate ( tMinusDelay ,
...
= ( _rtB -> B_6_40_0 <= C_fault_detection_under_varing_load_rtC ( S ) ->
B_6_5_0 ) ; } _rtB -> B_6_41_0 = _rtDW -> Compare_Mode_j ;
...
ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) ) ) ; } _rtB -> B_6_45_0 = _rtB
-> B_6_1_0_m - _rtB -> B_6_44_0 ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Compare_Mode_c
= ( _rtB -> B_6_45_0 <= C_fault_detection_under_varing_load_rtC ( S ) ->
B_6_4_0 ) ; } _rtB -> B_6_46_0 = _rtDW -> Compare_Mode_c ;
C_fault_detection_under_varing_load_SampleIL1 ( S , _rtB -> B_6_46_0 , _rtB
-> B_6_29_0 , & _rtB -> SampleIL2 , & _rtDW -> SampleIL2 , & _rtZCE ->
SampleIL2 ) ; C_fault_detection_under_varing_load_SampleIL1 ( S , _rtB ->
...
B_6_21_0 == C_fault_detection_under_varing_load_rtC ( S ) -> B_6_0_0 ) ;
_rtDW -> Compare_Mode_ji = ( _rtB -> B_6_44_0 ==
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_1_0 ) ; } _rtB ->
B_6_57_0 = _rtDW -> Compare_Mode_g ; _rtB -> B_6_58_0 = _rtDW ->
Compare_Mode_ji ; if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW ->
Compare_Mode_i = ( _rtB -> B_6_39_0 ==
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_2_0 ) ; } _rtB ->
B_6_59_0 = _rtDW -> Compare_Mode_i ; ssCallAccelRunBlock ( S , 6 , 60 ,
...
Tail , _rtDW -> TransportDelay_IWORK . Head , _rtP -> P_85 , 0 , ( boolean_T
...
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_6_97_0 = _rtB ->
B_6_36_0 ; _rtB -> B_6_107_0 = rtb_B_6_63_0 ; _rtDW -> Step_MODE = (
ssGetTaskTime ( S , 1 ) >= _rtP -> P_88 ) ; if ( _rtDW -> Step_MODE == 1 ) {
rtb_B_6_2_0 = _rtP -> P_90 ; } else { rtb_B_6_2_0 = _rtP -> P_89 ; } if (
rtb_B_6_2_0 > _rtP -> P_91 ) { _rtB -> B_6_127_0 = rtb_B_6_64_0 ; } else {
_rtB -> B_6_127_0 = _rtB -> B_6_6_0_c ; } } if ( ( _rtDW -> TimeStampA >=
ssGetT ( S ) ) && ( _rtDW -> TimeStampB >= ssGetT ( S ) ) ) { _rtB ->
B_6_131_0 = 0.0 ; } else { rtb_B_6_2_0 = _rtDW -> TimeStampA ; lastU = &
_rtDW -> LastUAtTimeA ; if ( _rtDW -> TimeStampA < _rtDW -> TimeStampB ) { if
( _rtDW -> TimeStampB < ssGetT ( S ) ) { rtb_B_6_2_0 = _rtDW -> TimeStampB ;
lastU = & _rtDW -> LastUAtTimeB ; } } else { if ( _rtDW -> TimeStampA >=
ssGetT ( S ) ) { rtb_B_6_2_0 = _rtDW -> TimeStampB ; lastU = & _rtDW ->
LastUAtTimeB ; } } _rtB -> B_6_131_0 = ( _rtB -> B_6_1_0 - * lastU ) / (
ssGetT ( S ) - rtb_B_6_2_0 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if (
isHit != 0 ) { _rtB -> B_6_133_0 = _rtP -> P_93 * _rtB -> B_6_9_0 [ 14 ] ;
_rtB -> B_6_134_0 = _rtP -> P_94 * _rtB -> B_6_9_0 [ 11 ] ; _rtB -> B_6_135_0
= _rtP -> P_95 * _rtB -> B_6_9_0 [ 13 ] ; _rtB -> B_6_136_0 = _rtP -> P_96 *
_rtB -> B_6_9_0 [ 10 ] ; ssCallAccelRunBlock ( S , 6 , 137 ,
...
int_T tid ) { B_C_fault_detection_under_varing_load_T * _rtB ;
P_C_fault_detection_under_varing_load_T * _rtP ; _rtP = ( (
P_C_fault_detection_under_varing_load_T * ) ssGetModelRtp ( S ) ) ; _rtB = (
( B_C_fault_detection_under_varing_load_T * ) _ssGetModelBlockIO ( S ) ) ;
memcpy ( & _rtB -> B_6_0_0 [ 0 ] , & _rtP -> P_102 [ 0 ] , 9U * sizeof (
real_T ) ) ; _rtB -> B_6_1_0_m = _rtP -> P_103 ; _rtB -> B_6_2_0 = _rtP ->
P_104 ; _rtB -> B_6_3_0 = _rtP -> P_105 ; _rtB -> B_6_4_0 = _rtP -> P_106 ;
_rtB -> B_6_5_0 = _rtP -> P_107 ; _rtB -> B_6_6_0_c = _rtP -> P_108 ; _rtB ->
B_6_7_0_k = _rtP -> P_109 ; _rtB -> B_6_8_0_c = _rtP -> P_110 ; _rtB ->
B_6_9_0_b = _rtP -> P_111 ; _rtB -> B_6_10_0_p = _rtP -> P_112 ;
UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
int32_T isHit ; B_C_fault_detection_under_varing_load_T * _rtB ;
P_C_fault_detection_under_varing_load_T * _rtP ;
DW_C_fault_detection_under_varing_load_T * _rtDW ; _rtDW = ( (
DW_C_fault_detection_under_varing_load_T * ) ssGetRootDWork ( S ) ) ; _rtP =
( ( P_C_fault_detection_under_varing_load_T * ) ssGetModelRtp ( S ) ) ; _rtB
= ( ( B_C_fault_detection_under_varing_load_T * ) _ssGetModelBlockIO ( S ) )
...
C_fault_detection_under_varing_load_acc_rt_TDelayUpdateTailOrGrowBuf ( &
_rtDW -> TransportDelay2_IWORK . CircularBufSize , & _rtDW ->
TransportDelay2_IWORK . Tail , & _rtDW -> TransportDelay2_IWORK . Head , &
_rtDW -> TransportDelay2_IWORK . Last , simTime - _rtP -> P_75 , tBuffer ,
...
TransportDelay2_IWORK . Head ] = _rtB -> B_6_74_0 ; } { real_T * * uBuffer =
...
TransportDelay1_IWORK . Tail , & _rtDW -> TransportDelay1_IWORK . Head , &
_rtDW -> TransportDelay1_IWORK . Last , simTime - _rtP -> P_77 , tBuffer ,
uBuffer , ( NULL ) , ( boolean_T ) 0 , false , & _rtDW ->
TransportDelay1_IWORK . MaxNewBufSize ) ) { ssSetErrorStatus ( S ,
"tdelay memory allocation error" ) ; return ; } } ( * tBuffer ) [ _rtDW ->
TransportDelay1_IWORK . Head ] = simTime ; ( * uBuffer ) [ _rtDW ->
TransportDelay1_IWORK . Head ] = _rtB -> B_6_69_0 ; } { real_T * * uBuffer =
( real_T * * ) & _rtDW -> TransportDelay_PWORK . TUbufferPtrs [ 0 ] ; real_T
* * tBuffer = ( real_T * * ) & _rtDW -> TransportDelay_PWORK . TUbufferPtrs [
1 ] ; real_T simTime = ssGetT ( S ) ; _rtDW -> TransportDelay_IWORK . Head =
...
B_C_fault_detection_under_varing_load_T * _rtB ;
XDot_C_fault_detection_under_varing_load_T * _rtXdot ; _rtXdot = ( (
XDot_C_fault_detection_under_varing_load_T * ) ssGetdX ( S ) ) ; _rtB = ( (
B_C_fault_detection_under_varing_load_T * ) _ssGetModelBlockIO ( S ) ) ;
_rtXdot -> Integrator_CSTATE = _rtB -> B_6_183_0 ; _rtXdot ->
Integrator_CSTATE_m = _rtB -> B_6_182_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) {
B_C_fault_detection_under_varing_load_T * _rtB ;
P_C_fault_detection_under_varing_load_T * _rtP ;
ZCV_C_fault_detection_under_varing_load_T * _rtZCSV ; _rtZCSV = ( (
ZCV_C_fault_detection_under_varing_load_T * ) ssGetSolverZcSignalVector ( S )
) ; _rtP = ( ( P_C_fault_detection_under_varing_load_T * ) ssGetModelRtp ( S
) ) ; _rtB = ( ( B_C_fault_detection_under_varing_load_T * )
_ssGetModelBlockIO ( S ) ) ; _rtZCSV -> Step2_StepTime_ZC = ssGetT ( S ) -
_rtP -> P_9 ; _rtZCSV -> Compare_RelopInput_ZC = _rtB -> B_6_22_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_3_0 ; _rtZCSV ->
Saturation_UprLim_ZC = _rtB -> B_6_34_0 - _rtP -> P_73 ; _rtZCSV ->
Saturation_LwrLim_ZC = _rtB -> B_6_34_0 - _rtP -> P_74 ; _rtZCSV ->
RelationalOperator_RelopInput_ZC = _rtB -> B_6_35_0 - _rtB -> B_6_21_0 ;
_rtZCSV -> Compare_RelopInput_ZC_n = _rtB -> B_6_40_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_5_0 ; _rtZCSV ->
Compare_RelopInput_ZC_a = _rtB -> B_6_45_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_4_0 ; _rtZCSV ->
Compare_RelopInput_ZC_e = _rtB -> B_6_21_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_0_0 ; _rtZCSV ->
Compare_RelopInput_ZC_av = _rtB -> B_6_44_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_1_0 ; _rtZCSV ->
Compare_RelopInput_ZC_j = _rtB -> B_6_39_0 -
C_fault_detection_under_varing_load_rtC ( S ) -> B_6_2_0 ; _rtZCSV ->
...
, 311607933U ) ; ssSetChecksumVal ( S , 1 , 2339848071U ) ; ssSetChecksumVal
( S , 2 , 1090127362U ) ; ssSetChecksumVal ( S , 3 , 562861167U ) ; { mxArray
...
S ) != sizeof ( DW_C_fault_detection_under_varing_load_T ) ) {
ssSetErrorStatus ( S , "Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_C_fault_detection_under_varing_load_T ) ) { ssSetErrorStatus
( S , "Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofY ( S ) != sizeof
( ExtY_C_fault_detection_under_varing_load_T ) ) { static char msg [ 256 ] ;
sprintf ( msg , "Unexpected error: Internal ExternalOutputs sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_C_fault_detection_under_varing_load_T ) ) { static char msg [ 256 ] ;
sprintf ( msg , "Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & C_fault_detection_under_varing_load_rtDefaultP ) ; _ssSetConstBlockIO ( S
, & C_fault_detection_under_varing_load_rtInvariant ) ; rt_InitInfAndNaN (
