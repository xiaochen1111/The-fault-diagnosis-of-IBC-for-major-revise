...
#ifndef RTW_HEADER_OCF_DCM_Test_acc_private_h_
#define RTW_HEADER_OCF_DCM_Test_acc_private_h_
#include "rtwtypes.h"
...
OCF_DCM_Test_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart ,
...
OCF_DCM_Test_SampleIL1_Init ( SimStruct * S , B_SampleIL1_OCF_DCM_Test_T *
localB , P_SampleIL1_OCF_DCM_Test_T * localP ) ; void OCF_DCM_Test_SampleIL1
( SimStruct * S , boolean_T rtu_Trigger , real_T rtu_In ,
B_SampleIL1_OCF_DCM_Test_T * localB , DW_SampleIL1_OCF_DCM_Test_T * localDW ,
ZCE_SampleIL1_OCF_DCM_Test_T * localZCE ) ;
#endif
