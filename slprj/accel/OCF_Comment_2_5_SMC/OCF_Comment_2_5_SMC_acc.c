...
#include "OCF_Comment_2_5_SMC_acc_private.h"
#include <stdio.h>
...
return ( true ) ; } real_T OCF_Comment_2_5_SMC_acc_rt_TDelayInterpolate (
...
P_SampleandHold_OCF_Comment_2_5_SMC_T * localP ) { localB -> B_1_0_0 = localP
-> P_0 ; } void OCF_Comment_2_5_SMC_SampleandHold ( SimStruct * S , real_T
rtu_Trigger , real_T rtu_In , B_SampleandHold_OCF_Comment_2_5_SMC_T * localB
, DW_SampleandHold_OCF_Comment_2_5_SMC_T * localDW ,
ZCE_SampleandHold_OCF_Comment_2_5_SMC_T * localZCE ) { ZCEventType zcEvent ;
...
OCF_Comment_2_5_SMC_SampleandHold_Term ( SimStruct * const S ) { } static
void mdlOutputs ( SimStruct * S , int_T tid ) { real_T * lastU ; real_T
rtb_B_4_2_0 ; uint32_T numCycles ; real_T ratio ; int32_T isHit ;
B_OCF_Comment_2_5_SMC_T * _rtB ; P_OCF_Comment_2_5_SMC_T * _rtP ;
PrevZCX_OCF_Comment_2_5_SMC_T * _rtZCE ; DW_OCF_Comment_2_5_SMC_T * _rtDW ;
_rtDW = ( ( DW_OCF_Comment_2_5_SMC_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = (
( PrevZCX_OCF_Comment_2_5_SMC_T * ) _ssGetPrevZCSigState ( S ) ) ; _rtP = ( (
P_OCF_Comment_2_5_SMC_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_OCF_Comment_2_5_SMC_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_4_1_0 =
rt_Lookup ( _rtP -> P_1 , 6 , ssGetT ( S ) , _rtP -> P_2 ) ; isHit =
...
muDoubleScalarAbs ( rtb_B_4_2_0 ) > _rtP -> P_6 ) ) { if ( muDoubleScalarSign
( rtb_B_4_2_0 ) > _rtP -> P_0 ) { rtb_B_4_2_0 = _rtB -> B_4_3_0 ; } else {
rtb_B_4_2_0 = _rtB -> B_4_4_0 ; } } _rtB -> B_4_6_0 = _rtB -> B_4_2_0 /
rtb_B_4_2_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) {
_rtB -> B_4_7_0 = _rtDW -> UnitDelay_DSTATE ; } isHit = ssIsSampleHit ( S , 1
, 0 ) ; if ( isHit != 0 ) { _rtB -> B_4_8_0 = _rtB -> B_4_6_0 - _rtB ->
B_4_7_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) {
ssCallAccelRunBlock ( S , 4 , 9 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_4_11_0 =
_rtP -> P_57 * _rtB -> B_4_9_0 [ 10 ] ; rtb_B_4_2_0 = ( _rtB -> B_4_11_0 -
_rtP -> P_56 * _rtB -> B_4_9_0 [ 9 ] ) * _rtP -> P_58 ; rtb_B_4_2_0 = ( ( (
_rtB -> B_4_6_0_c - _rtP -> P_59 * _rtB -> B_4_11_0 ) * _rtP -> P_60 +
rtb_B_4_2_0 ) - _rtP -> P_61 * _rtB -> B_4_9_0 [ 19 ] * _rtP -> P_62 ) -
rtb_B_4_2_0 ; _rtDW -> Relay_Mode = ( ( rtb_B_4_2_0 >= _rtP -> P_63 ) || ( (
! ( rtb_B_4_2_0 <= _rtP -> P_64 ) ) && _rtDW -> Relay_Mode ) ) ; if ( _rtDW
-> Relay_Mode ) { _rtB -> B_4_21_0 = _rtP -> P_65 ; } else { _rtB -> B_4_21_0
= _rtP -> P_66 ; } } isHit = ssIsSampleHit ( S , 5 , 0 ) ; if ( isHit != 0 )
{ rtb_B_4_2_0 = ssGetTaskTime ( S , 5 ) ; if ( ssGetTNextWasAdjusted ( S , 5
) != 0 ) { _rtDW -> nextTime = _ssGetVarNextHitTime ( S , 2 ) ; } if ( _rtDW
-> justEnabled != 0 ) { _rtDW -> justEnabled = 0 ; if ( rtb_B_4_2_0 >= _rtP
-> P_70 ) { ratio = ( rtb_B_4_2_0 - _rtP -> P_70 ) / _rtP -> P_68 ; numCycles
...
_rtP -> P_68 + _rtP -> P_70 ) + _rtP -> P_69 * _rtP -> P_68 / 100.0 ; if (
...
= OCF_Comment_2_5_SMC_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
-> B_4_27_0 = _rtP -> P_73 * _rtB -> B_4_9_0 [ 18 ] ; _rtB -> B_4_28_0 = _rtP
-> P_74 * _rtB -> B_4_9_0 [ 11 ] ; _rtB -> B_4_29_0 = _rtP -> P_75 * _rtB ->
B_4_9_0 [ 12 ] ; _rtB -> B_4_30_0 = _rtP -> P_76 * _rtB -> B_4_9_0 [ 13 ] ;
ssCallAccelRunBlock ( S , 4 , 31 , SS_CALL_MDL_OUTPUTS ) ; } isHit =
ssIsSampleHit ( S , 3 , 0 ) ; if ( isHit != 0 ) { rtb_B_4_2_0 = ssGetTaskTime
( S , 3 ) ; if ( ssGetTNextWasAdjusted ( S , 3 ) != 0 ) { _rtDW -> nextTime_p
= _ssGetVarNextHitTime ( S , 0 ) ; } if ( _rtDW -> justEnabled_c != 0 ) {
_rtDW -> justEnabled_c = 0 ; if ( rtb_B_4_2_0 >= _rtP -> P_80 ) { ratio = (
rtb_B_4_2_0 - _rtP -> P_80 ) / _rtP -> P_78 ; numCycles = ( uint32_T )
...
P_78 + _rtP -> P_80 ) + _rtP -> P_79 * _rtP -> P_78 / 100.0 ; if (
rtb_B_4_2_0 < ratio ) { _rtDW -> currentValue_i = 1 ; _rtDW -> nextTime_p =
ratio ; } else { _rtDW -> currentValue_i = 0 ; _rtDW -> nextTime_p = ( real_T
) ( numCycles + 1U ) * _rtP -> P_78 + _rtP -> P_80 ; } } else { _rtDW ->
numCompleteCycles_e = _rtP -> P_80 != 0.0 ? - 1 : 0 ; _rtDW -> currentValue_i
= 0 ; _rtDW -> nextTime_p = _rtP -> P_80 ; } } else { if ( _rtDW ->
nextTime_p <= rtb_B_4_2_0 ) { if ( _rtDW -> currentValue_i == 1 ) { _rtDW ->
currentValue_i = 0 ; _rtDW -> nextTime_p = ( real_T ) ( _rtDW ->
numCompleteCycles_e + 1LL ) * _rtP -> P_78 + _rtP -> P_80 ; } else { _rtDW ->
numCompleteCycles_e ++ ; _rtDW -> currentValue_i = 1 ; _rtDW -> nextTime_p =
( _rtP -> P_79 * _rtP -> P_78 * 0.01 + ( real_T ) _rtDW ->
numCompleteCycles_e * _rtP -> P_78 ) + _rtP -> P_80 ; } } }
_ssSetVarNextHitTime ( S , 0 , _rtDW -> nextTime_p ) ; if ( _rtDW ->
currentValue_i == 1 ) { _rtB -> B_4_32_0 = _rtP -> P_77 ; } else { _rtB ->
B_4_32_0 = 0.0 ; } } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_4_33_0 = ( ( _rtB -> B_4_21_0 != 0.0 ) && ( _rtB -> B_4_32_0 !=
...
_rtP -> P_84 ) { ratio = ( rtb_B_4_2_0 - _rtP -> P_84 ) / _rtP -> P_82 ;
...
( ( real_T ) numCycles * _rtP -> P_82 + _rtP -> P_84 ) + _rtP -> P_83 * _rtP
-> P_82 / 100.0 ; if ( rtb_B_4_2_0 < ratio ) { _rtDW -> currentValue_k = 1 ;
_rtDW -> nextTime_h = ratio ; } else { _rtDW -> currentValue_k = 0 ; _rtDW ->
nextTime_h = ( real_T ) ( numCycles + 1U ) * _rtP -> P_82 + _rtP -> P_84 ; }
} else { _rtDW -> numCompleteCycles_i = _rtP -> P_84 != 0.0 ? - 1 : 0 ; _rtDW
-> currentValue_k = 0 ; _rtDW -> nextTime_h = _rtP -> P_84 ; } } else { if (
_rtDW -> nextTime_h <= rtb_B_4_2_0 ) { if ( _rtDW -> currentValue_k == 1 ) {
_rtDW -> currentValue_k = 0 ; _rtDW -> nextTime_h = ( real_T ) ( _rtDW ->
numCompleteCycles_i + 1LL ) * _rtP -> P_82 + _rtP -> P_84 ; } else { _rtDW ->
numCompleteCycles_i ++ ; _rtDW -> currentValue_k = 1 ; _rtDW -> nextTime_h =
( _rtP -> P_83 * _rtP -> P_82 * 0.01 + ( real_T ) _rtDW ->
numCompleteCycles_i * _rtP -> P_82 ) + _rtP -> P_84 ; } } }
_ssSetVarNextHitTime ( S , 1 , _rtDW -> nextTime_h ) ; if ( _rtDW ->
currentValue_k == 1 ) { _rtB -> B_4_34_0 = _rtP -> P_81 ; } else { _rtB ->
B_4_34_0 = 0.0 ; } } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_4_35_0 = ( ( _rtB -> B_4_21_0 != 0.0 ) && ( _rtB -> B_4_34_0 !=
0.0 ) ) ; ssCallAccelRunBlock ( S , 4 , 36 , SS_CALL_MDL_OUTPUTS ) ; } {
real_T * * uBuffer = ( real_T * * ) & _rtDW -> TransportDelay3_PWORK .
TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T * * ) & _rtDW ->
TransportDelay3_PWORK . TUbufferPtrs [ 1 ] ; real_T simTime = ssGetT ( S ) ;
real_T tMinusDelay = simTime - _rtP -> P_85 ; _rtB -> B_4_37_0 =
OCF_Comment_2_5_SMC_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * tBuffer
...
-> TransportDelay3_IWORK . Head , _rtP -> P_86 , 1 , ( boolean_T ) (
ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) )
) ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
OCF_Comment_2_5_SMC_SampleandHold ( S , _rtB -> B_4_37_0 , _rtB -> B_4_27_0 ,
& _rtB -> SampleandHold , & _rtDW -> SampleandHold , & _rtZCE ->
SampleandHold ) ; } { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay1_PWORK . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T *
* ) & _rtDW -> TransportDelay1_PWORK . TUbufferPtrs [ 1 ] ; real_T simTime =
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_87 ; _rtB -> B_4_39_0
= OCF_Comment_2_5_SMC_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
OCF_Comment_2_5_SMC_SampleandHold ( S , _rtB -> B_4_39_0 , _rtB -> B_4_27_0 ,
...
, _rtDW -> TransportDelay2_IWORK . Head , _rtP -> P_90 , 1 , ( boolean_T ) (
ssIsMinorTimeStep ( S ) && ( ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) )
) ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) {
OCF_Comment_2_5_SMC_SampleandHold ( S , _rtB -> B_4_41_0 , _rtB -> B_4_27_0 ,
& _rtB -> SampleandHold2 , & _rtDW -> SampleandHold2 , & _rtZCE ->
SampleandHold2 ) ; ssCallAccelRunBlock ( S , 4 , 43 , SS_CALL_MDL_OUTPUTS ) ;
_rtB -> B_4_59_0 = _rtB -> B_4_23_0 ; _rtDW -> Step_MODE = ( ssGetTaskTime (
S , 1 ) >= _rtP -> P_91 ) ; if ( _rtDW -> Step_MODE == 1 ) { rtb_B_4_2_0 =
_rtP -> P_93 ; } else { rtb_B_4_2_0 = _rtP -> P_92 ; } if ( rtb_B_4_2_0 >
_rtP -> P_94 ) { _rtB -> B_4_79_0 = _rtB -> B_4_33_0 ; } else { _rtB ->
B_4_79_0 = _rtB -> B_4_1_0_m ; } _rtB -> B_4_80_0 = _rtB -> B_4_35_0 ; } if (
( _rtDW -> TimeStampA >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB >= ssGetT (
S ) ) ) { _rtB -> B_4_93_0 = 0.0 ; } else { rtb_B_4_2_0 = _rtDW -> TimeStampA
...
isHit != 0 ) { ssCallAccelRunBlock ( S , 4 , 148 , SS_CALL_MDL_OUTPUTS ) ;
_rtB -> B_4_149_0 = _rtB -> B_4_23_0 ; _rtB -> B_4_150_0 = _rtB -> B_4_33_0 ;
_rtB -> B_4_151_0 = _rtB -> B_4_35_0 ; } ssCallAccelRunBlock ( S , 4 , 152 ,
SS_CALL_MDL_OUTPUTS ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0
) { _rtB -> B_4_153_0 = _rtB -> B_4_33_0 ; _rtB -> B_4_154_0 = _rtB ->
B_4_23_0 ; _rtB -> B_4_155_0 = _rtB -> B_4_35_0 ; } UNUSED_PARAMETER ( tid )
; } static void mdlOutputsTID6 ( SimStruct * S , int_T tid ) {
B_OCF_Comment_2_5_SMC_T * _rtB ; P_OCF_Comment_2_5_SMC_T * _rtP ; _rtP = ( (
P_OCF_Comment_2_5_SMC_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_OCF_Comment_2_5_SMC_T * ) _ssGetModelBlockIO ( S ) ) ; memcpy ( & _rtB ->
B_4_0_0 [ 0 ] , & _rtP -> P_103 [ 0 ] , 9U * sizeof ( real_T ) ) ; _rtB ->
B_4_1_0_m = _rtP -> P_104 ; _rtB -> B_4_2_0 = _rtP -> P_105 ; _rtB -> B_4_3_0
= _rtP -> P_106 ; _rtB -> B_4_4_0 = _rtP -> P_107 ; _rtB -> B_4_6_0_c = _rtP
-> P_109 * _rtP -> P_108 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
int32_T isHit ; B_OCF_Comment_2_5_SMC_T * _rtB ; P_OCF_Comment_2_5_SMC_T *
_rtP ; DW_OCF_Comment_2_5_SMC_T * _rtDW ; _rtDW = ( (
DW_OCF_Comment_2_5_SMC_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_OCF_Comment_2_5_SMC_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_OCF_Comment_2_5_SMC_T * ) _ssGetModelBlockIO ( S ) ) ; isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtDW -> UnitDelay_DSTATE =
_rtB -> B_4_6_0 ; ssCallAccelRunBlock ( S , 4 , 9 , SS_CALL_MDL_UPDATE ) ; }
...
OCF_Comment_2_5_SMC_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
B_4_154_0 ; } { real_T * * uBuffer = ( real_T * * ) & _rtDW ->
TransportDelay1_PWORK . TUbufferPtrs [ 0 ] ; real_T * * tBuffer = ( real_T *
* ) & _rtDW -> TransportDelay1_PWORK . TUbufferPtrs [ 1 ] ; real_T simTime =
...
B_4_155_0 ; } if ( _rtDW -> TimeStampA == ( rtInf ) ) { _rtDW -> TimeStampA =
...
static void mdlZeroCrossings ( SimStruct * S ) { B_OCF_Comment_2_5_SMC_T *
_rtB ; P_OCF_Comment_2_5_SMC_T * _rtP ; ZCV_OCF_Comment_2_5_SMC_T * _rtZCSV ;
_rtZCSV = ( ( ZCV_OCF_Comment_2_5_SMC_T * ) ssGetSolverZcSignalVector ( S ) )
; _rtP = ( ( P_OCF_Comment_2_5_SMC_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_OCF_Comment_2_5_SMC_T * ) _ssGetModelBlockIO ( S ) ) ; _rtZCSV ->
Step2_StepTime_ZC = ssGetT ( S ) - _rtP -> P_3 ; _rtZCSV -> Step_StepTime_ZC
= ssGetT ( S ) - _rtP -> P_91 ; _rtZCSV -> HitCrossing_HitNoOutput_ZC = _rtB
-> B_4_93_0 - _rtP -> P_95 ; _rtZCSV -> HitCrossing_HitNoOutput_ZC_d = _rtB
-> B_4_120_0 - _rtP -> P_102 ; } static void mdlInitializeSizes ( SimStruct *
S ) { ssSetChecksumVal ( S , 0 , 4262455923U ) ; ssSetChecksumVal ( S , 1 ,
3765600205U ) ; ssSetChecksumVal ( S , 2 , 3557645920U ) ; ssSetChecksumVal (
S , 3 , 915032143U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat
...
DW_OCF_Comment_2_5_SMC_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_OCF_Comment_2_5_SMC_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_OCF_Comment_2_5_SMC_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & OCF_Comment_2_5_SMC_rtDefaultP ) ; rt_InitInfAndNaN ( sizeof ( real_T ) )
