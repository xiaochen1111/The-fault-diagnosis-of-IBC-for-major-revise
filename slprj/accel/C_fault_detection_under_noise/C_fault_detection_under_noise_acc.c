...
#include <math.h>
#include "C_fault_detection_under_noise_acc.h"
#include "C_fault_detection_under_noise_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T C_fault_detection_under_noise_acc_rt_TDelayUpdateTailOrGrowBuf (
...
C_fault_detection_under_noise_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
...
C_fault_detection_under_noise_SampleIL1_Init ( SimStruct * S ,
B_SampleIL1_C_fault_detection_under_noise_T * localB ,
P_SampleIL1_C_fault_detection_under_noise_T * localP ) { localB -> B_4_0_0 =
localP -> P_0 ; } void C_fault_detection_under_noise_SampleIL1 ( SimStruct *
S , boolean_T rtu_Trigger , real_T rtu_In ,
B_SampleIL1_C_fault_detection_under_noise_T * localB ,
DW_SampleIL1_C_fault_detection_under_noise_T * localDW ,
ZCE_SampleIL1_C_fault_detection_under_noise_T * localZCE ) { if (
...
} } void C_fault_detection_under_noise_SampleIL1_Term ( SimStruct * const S )
...
rtb_B_9_67_0 ; int32_T isHit ; B_C_fault_detection_under_noise_T * _rtB ;
P_C_fault_detection_under_noise_T * _rtP ; X_C_fault_detection_under_noise_T
* _rtX ; PrevZCX_C_fault_detection_under_noise_T * _rtZCE ;
DW_C_fault_detection_under_noise_T * _rtDW ; _rtDW = ( (
DW_C_fault_detection_under_noise_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = ( (
PrevZCX_C_fault_detection_under_noise_T * ) _ssGetPrevZCSigState ( S ) ) ;
_rtX = ( ( X_C_fault_detection_under_noise_T * ) ssGetContStates ( S ) ) ;
_rtP = ( ( P_C_fault_detection_under_noise_T * ) ssGetModelRtp ( S ) ) ; _rtB
= ( ( B_C_fault_detection_under_noise_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB
-> B_9_1_0 = rt_Lookup ( _rtP -> P_7 , 6 , ssGetT ( S ) , _rtP -> P_8 ) ;
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { _rtDW -> Step2_MODE
= ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_9 ) ; if ( _rtDW -> Step2_MODE == 1
) { rtb_B_9_2_0 = _rtP -> P_11 ; } else { rtb_B_9_2_0 = _rtP -> P_10 ; } if (
! ( muDoubleScalarAbs ( rtb_B_9_2_0 ) > _rtP -> P_12 ) ) { if (
muDoubleScalarSign ( rtb_B_9_2_0 ) > _rtP -> P_0 ) { rtb_B_9_2_0 = _rtB ->
B_9_8_0_c ; } else { rtb_B_9_2_0 = _rtB -> B_9_9_0_b ; } } _rtB -> B_9_6_0 =
_rtB -> B_9_7_0_k / rtb_B_9_2_0 ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if
( isHit != 0 ) { _rtB -> B_9_7_0 = _rtDW -> UnitDelay_DSTATE ; } isHit =
...
B_9_22_0 <= C_fault_detection_under_noise_rtC ( S ) -> B_9_3_0 ) ; } _rtB ->
B_9_23_0 = _rtDW -> Compare_Mode ; C_fault_detection_under_noise_SampleIL1 (
...
if ( isHit != 0 ) { C_fault_detection_under_noise_SampleIL1 ( S , _rtB ->
...
C_fault_detection_under_noise_SampleIL1 ( S , _rtB -> B_9_23_0 , _rtB ->
...
C_fault_detection_under_noise_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 ,
...
C_fault_detection_under_noise_rtC ( S ) -> B_9_5_0 ) ; } _rtB -> B_9_44_0 =
...
C_fault_detection_under_noise_rtC ( S ) -> B_9_4_0 ) ; } _rtB -> B_9_50_0 =
_rtDW -> Compare_Mode_c ; C_fault_detection_under_noise_SampleIL1 ( S , _rtB
-> B_9_50_0 , _rtB -> B_9_32_0 , & _rtB -> SampleIL2 , & _rtDW -> SampleIL2 ,
& _rtZCE -> SampleIL2 ) ; C_fault_detection_under_noise_SampleIL1 ( S , _rtB
...
B_9_21_0 == C_fault_detection_under_noise_rtC ( S ) -> B_9_0_0 ) ; _rtDW ->
Compare_Mode_ji = ( _rtB -> B_9_48_0 == C_fault_detection_under_noise_rtC ( S
) -> B_9_1_0 ) ; } _rtB -> B_9_61_0 = _rtDW -> Compare_Mode_g ; _rtB ->
B_9_62_0 = _rtDW -> Compare_Mode_ji ; if ( ssIsMajorTimeStep ( S ) != 0 ) {
_rtDW -> Compare_Mode_i = ( _rtB -> B_9_42_0 ==
C_fault_detection_under_noise_rtC ( S ) -> B_9_2_0 ) ; } _rtB -> B_9_63_0 =
...
B_C_fault_detection_under_noise_T * _rtB ; P_C_fault_detection_under_noise_T
* _rtP ; _rtP = ( ( P_C_fault_detection_under_noise_T * ) ssGetModelRtp ( S )
) ; _rtB = ( ( B_C_fault_detection_under_noise_T * ) _ssGetModelBlockIO ( S )
) ; memcpy ( & _rtB -> B_9_0_0 [ 0 ] , & _rtP -> P_102 [ 0 ] , 9U * sizeof (
real_T ) ) ; _rtB -> B_9_1_0_m = _rtP -> P_103 ; _rtB -> B_9_2_0 = _rtP ->
P_104 ; _rtB -> B_9_3_0 = _rtP -> P_105 ; _rtB -> B_9_4_0 = _rtP -> P_106 ;
_rtB -> B_9_5_0 = _rtP -> P_107 ; _rtB -> B_9_6_0_c = _rtP -> P_108 ; _rtB ->
B_9_7_0_k = _rtP -> P_109 ; _rtB -> B_9_8_0_c = _rtP -> P_110 ; _rtB ->
B_9_9_0_b = _rtP -> P_111 ; _rtB -> B_9_10_0_p = _rtP -> P_112 ;
UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
int32_T isHit ; B_C_fault_detection_under_noise_T * _rtB ;
P_C_fault_detection_under_noise_T * _rtP ; DW_C_fault_detection_under_noise_T
* _rtDW ; _rtDW = ( ( DW_C_fault_detection_under_noise_T * ) ssGetRootDWork (
S ) ) ; _rtP = ( ( P_C_fault_detection_under_noise_T * ) ssGetModelRtp ( S )
) ; _rtB = ( ( B_C_fault_detection_under_noise_T * ) _ssGetModelBlockIO ( S )
) ; isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtDW ->
UnitDelay_DSTATE = _rtB -> B_9_6_0 ; ssCallAccelRunBlock ( S , 9 , 9 ,
...
C_fault_detection_under_noise_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
B_C_fault_detection_under_noise_T * _rtB ;
XDot_C_fault_detection_under_noise_T * _rtXdot ; _rtXdot = ( (
XDot_C_fault_detection_under_noise_T * ) ssGetdX ( S ) ) ; _rtB = ( (
B_C_fault_detection_under_noise_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_9_187_0 ; _rtXdot -> Integrator_CSTATE_m = _rtB
-> B_9_186_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) {
B_C_fault_detection_under_noise_T * _rtB ; P_C_fault_detection_under_noise_T
* _rtP ; ZCV_C_fault_detection_under_noise_T * _rtZCSV ; _rtZCSV = ( (
ZCV_C_fault_detection_under_noise_T * ) ssGetSolverZcSignalVector ( S ) ) ;
_rtP = ( ( P_C_fault_detection_under_noise_T * ) ssGetModelRtp ( S ) ) ; _rtB
= ( ( B_C_fault_detection_under_noise_T * ) _ssGetModelBlockIO ( S ) ) ;
_rtZCSV -> Step2_StepTime_ZC = ssGetT ( S ) - _rtP -> P_9 ; _rtZCSV ->
Compare_RelopInput_ZC = _rtB -> B_9_22_0 - C_fault_detection_under_noise_rtC
...
C_fault_detection_under_noise_rtC ( S ) -> B_9_5_0 ; _rtZCSV ->
Compare_RelopInput_ZC_a = _rtB -> B_9_49_0 -
C_fault_detection_under_noise_rtC ( S ) -> B_9_4_0 ; _rtZCSV ->
Compare_RelopInput_ZC_e = _rtB -> B_9_21_0 -
C_fault_detection_under_noise_rtC ( S ) -> B_9_0_0 ; _rtZCSV ->
Compare_RelopInput_ZC_av = _rtB -> B_9_48_0 -
C_fault_detection_under_noise_rtC ( S ) -> B_9_1_0 ; _rtZCSV ->
Compare_RelopInput_ZC_j = _rtB -> B_9_42_0 -
C_fault_detection_under_noise_rtC ( S ) -> B_9_2_0 ; _rtZCSV ->
...
, 2472408337U ) ; ssSetChecksumVal ( S , 1 , 2861007518U ) ; ssSetChecksumVal
( S , 2 , 2390408934U ) ; ssSetChecksumVal ( S , 3 , 4107813761U ) ; {
...
( S ) != sizeof ( DW_C_fault_detection_under_noise_T ) ) { ssSetErrorStatus (
S , "Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_C_fault_detection_under_noise_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofY ( S ) != sizeof
( ExtY_C_fault_detection_under_noise_T ) ) { static char msg [ 256 ] ;
sprintf ( msg , "Unexpected error: Internal ExternalOutputs sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_C_fault_detection_under_noise_T ) ) { static char msg [ 256 ] ; sprintf (
msg , "Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & C_fault_detection_under_noise_rtDefaultP ) ; _ssSetConstBlockIO ( S , &
C_fault_detection_under_noise_rtInvariant ) ; rt_InitInfAndNaN ( sizeof (
