...
#ifndef RTW_HEADER_C_fault_detection_idenfication_acc_private_h_
#define RTW_HEADER_C_fault_detection_idenfication_acc_private_h_
#include "rtwtypes.h"
...
uint32_T maxIndex ) ; void C_fault_detection_idenfication_SampleIL1_Init (
SimStruct * S , B_SampleIL1_C_fault_detection_idenfication_T * localB ,
P_SampleIL1_C_fault_detection_idenfication_T * localP ) ; void
C_fault_detection_idenfication_SampleIL1 ( SimStruct * S , boolean_T
rtu_Trigger , real_T rtu_In , B_SampleIL1_C_fault_detection_idenfication_T *
localB , DW_SampleIL1_C_fault_detection_idenfication_T * localDW ,
ZCE_SampleIL1_C_fault_detection_idenfication_T * localZCE ) ;
#endif
