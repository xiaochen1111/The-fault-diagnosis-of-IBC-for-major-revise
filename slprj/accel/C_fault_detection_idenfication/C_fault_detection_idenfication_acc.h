...
#ifndef RTW_HEADER_C_fault_detection_idenfication_acc_h_
#define RTW_HEADER_C_fault_detection_idenfication_acc_h_
#include <stddef.h>
#include <float.h>
#include <string.h>
#ifndef C_fault_detection_idenfication_acc_COMMON_INCLUDES_
#define C_fault_detection_idenfication_acc_COMMON_INCLUDES_
#include <stdlib.h>
...
#endif
#include "C_fault_detection_idenfication_acc_types.h"
...
B_SampleIL1_C_fault_detection_idenfication_T ; typedef struct { int32_T
SampleIL1_sysIdxToRun ; int8_T SampleIL1_SubsysRanBC ; char_T
pad_SampleIL1_SubsysRanBC [ 3 ] ; }
DW_SampleIL1_C_fault_detection_idenfication_T ; typedef struct { real_T
SampleIL1_Trig_ZC ; } ZCV_SampleIL1_C_fault_detection_idenfication_T ;
typedef struct { ZCSigState SampleIL1_Trig_ZCE ; }
ZCE_SampleIL1_C_fault_detection_idenfication_T ; typedef struct { real_T
...
B_SampleIL1_C_fault_detection_idenfication_T SampleandHold1 ;
B_SampleIL1_C_fault_detection_idenfication_T SampleIL4 ;
B_SampleIL1_C_fault_detection_idenfication_T SampleIL3 ;
B_SampleIL1_C_fault_detection_idenfication_T SampleIL2 ;
B_SampleIL1_C_fault_detection_idenfication_T SampleIL1 ; }
B_C_fault_detection_idenfication_T ; typedef struct { real_T UnitDelay_DSTATE
...
DW_SampleIL1_C_fault_detection_idenfication_T SampleandHold1 ;
DW_SampleIL1_C_fault_detection_idenfication_T SampleIL4 ;
DW_SampleIL1_C_fault_detection_idenfication_T SampleIL3 ;
DW_SampleIL1_C_fault_detection_idenfication_T SampleIL2 ;
DW_SampleIL1_C_fault_detection_idenfication_T SampleIL1 ; }
DW_C_fault_detection_idenfication_T ; typedef struct { real_T
Integrator_CSTATE ; real_T Integrator_CSTATE_m ; }
X_C_fault_detection_idenfication_T ; typedef struct { real_T
Integrator_CSTATE ; real_T Integrator_CSTATE_m ; }
XDot_C_fault_detection_idenfication_T ; typedef struct { boolean_T
Integrator_CSTATE ; boolean_T Integrator_CSTATE_m ; }
XDis_C_fault_detection_idenfication_T ; typedef struct { real_T
Integrator_CSTATE ; real_T Integrator_CSTATE_m ; }
CStateAbsTol_C_fault_detection_idenfication_T ; typedef struct { real_T
...
HitCrossing_HitNoOutput_ZC_k ; ZCV_SampleIL1_C_fault_detection_idenfication_T
SampleandHold1 ; ZCV_SampleIL1_C_fault_detection_idenfication_T SampleIL4 ;
ZCV_SampleIL1_C_fault_detection_idenfication_T SampleIL3 ;
ZCV_SampleIL1_C_fault_detection_idenfication_T SampleIL2 ;
ZCV_SampleIL1_C_fault_detection_idenfication_T SampleIL1 ; }
ZCV_C_fault_detection_idenfication_T ; typedef struct { ZCSigState
...
ZCE_SampleIL1_C_fault_detection_idenfication_T SampleandHold1 ;
ZCE_SampleIL1_C_fault_detection_idenfication_T SampleIL4 ;
ZCE_SampleIL1_C_fault_detection_idenfication_T SampleIL3 ;
ZCE_SampleIL1_C_fault_detection_idenfication_T SampleIL2 ;
ZCE_SampleIL1_C_fault_detection_idenfication_T SampleIL1 ; }
PrevZCX_C_fault_detection_idenfication_T ; typedef struct { const real_T
B_9_0_0 ; const real_T B_9_1_0 ; const real_T B_9_2_0 ; const real_T B_9_3_0
; const real_T B_9_4_0 ; const real_T B_9_5_0 ; }
ConstB_C_fault_detection_idenfication_T ;
#define C_fault_detection_idenfication_rtC(S) ((ConstB_C_fault_detection_idenfication_T *) _ssGetConstBlockIO(S))
typedef struct { real_T * B_5_2 ; real_T * B_5_3 ; real_T * B_5_4 ; }
ExtY_C_fault_detection_idenfication_T ; struct
P_SampleIL1_C_fault_detection_idenfication_T_ { real_T P_0 ; } ; struct
P_C_fault_detection_idenfication_T_ { real_T P_0 ; real_T P_1 ; real_T P_2 ;
...
P_SampleIL1_C_fault_detection_idenfication_T SampleandHold1 ;
P_SampleIL1_C_fault_detection_idenfication_T SampleIL4 ;
P_SampleIL1_C_fault_detection_idenfication_T SampleIL3 ;
P_SampleIL1_C_fault_detection_idenfication_T SampleIL2 ;
P_SampleIL1_C_fault_detection_idenfication_T SampleIL1 ; } ; extern
P_C_fault_detection_idenfication_T C_fault_detection_idenfication_rtDefaultP
; extern const ConstB_C_fault_detection_idenfication_T
C_fault_detection_idenfication_rtInvariant ;
#endif
