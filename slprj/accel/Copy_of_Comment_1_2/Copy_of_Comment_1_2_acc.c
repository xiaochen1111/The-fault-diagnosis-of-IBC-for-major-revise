#include "__cf_Copy_of_Comment_1_2.h"
#include <math.h>
#include "Copy_of_Comment_1_2_acc.h"
#include "Copy_of_Comment_1_2_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T Copy_of_Comment_1_2_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
...
return ( true ) ; } real_T Copy_of_Comment_1_2_acc_rt_TDelayInterpolate (
...
void Copy_of_Comment_1_2_SampleIL1_Init ( SimStruct * S ,
B_SampleIL1_Copy_of_Comment_1_2_T * localB ,
P_SampleIL1_Copy_of_Comment_1_2_T * localP ) { localB -> B_1_0_0 = localP ->
P_0 ; } void Copy_of_Comment_1_2_SampleIL1 ( SimStruct * S , boolean_T
rtu_Trigger , real_T rtu_In , B_SampleIL1_Copy_of_Comment_1_2_T * localB ,
DW_SampleIL1_Copy_of_Comment_1_2_T * localDW ,
ZCE_SampleIL1_Copy_of_Comment_1_2_T * localZCE ) { if ( ssIsMajorTimeStep ( S
...
Copy_of_Comment_1_2_SampleIL1_Term ( SimStruct * const S ) { } static void
mdlOutputs ( SimStruct * S , int_T tid ) { real_T * lastU ; real_T
rtb_B_6_25_0 ; real_T rtb_B_6_2_0 ; boolean_T rtb_B_6_64_0 ; boolean_T
rtb_B_6_63_0 ; int32_T isHit ; B_Copy_of_Comment_1_2_T * _rtB ;
P_Copy_of_Comment_1_2_T * _rtP ; X_Copy_of_Comment_1_2_T * _rtX ;
PrevZCX_Copy_of_Comment_1_2_T * _rtZCE ; DW_Copy_of_Comment_1_2_T * _rtDW ;
_rtDW = ( ( DW_Copy_of_Comment_1_2_T * ) ssGetRootDWork ( S ) ) ; _rtZCE = (
( PrevZCX_Copy_of_Comment_1_2_T * ) _ssGetPrevZCSigState ( S ) ) ; _rtX = ( (
X_Copy_of_Comment_1_2_T * ) ssGetContStates ( S ) ) ; _rtP = ( (
P_Copy_of_Comment_1_2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_Copy_of_Comment_1_2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtB -> B_6_1_0 =
rt_Lookup ( _rtP -> P_7 , 6 , ssGetT ( S ) , _rtP -> P_8 ) ; isHit =
...
B_6_22_0 <= Copy_of_Comment_1_2_rtC ( S ) -> B_6_3_0 ) ; } _rtB -> B_6_23_0 =
_rtDW -> Compare_Mode ; Copy_of_Comment_1_2_SampleIL1 ( S , _rtB -> B_6_23_0
, _rtB -> B_6_16_0 , & _rtB -> SampleIL4 , & _rtDW -> SampleIL4 , & _rtZCE ->
SampleIL4 ) ; rtb_B_6_25_0 = _rtB -> B_6_10_0_p - _rtB -> SampleIL4 . B_1_0_0
; _rtB -> B_6_26_0 = _rtP -> P_68 * rtb_B_6_25_0 ; } _rtB -> B_6_27_0 = _rtX
...
) ; if ( isHit != 0 ) { Copy_of_Comment_1_2_SampleIL1 ( S , _rtB -> B_6_23_0
, _rtB -> B_6_29_0 , & _rtB -> SampleIL1 , & _rtDW -> SampleIL1 , & _rtZCE ->
...
B_6_36_0 = _rtDW -> RelationalOperator_Mode ; Copy_of_Comment_1_2_SampleIL1 (
S , _rtB -> B_6_23_0 , _rtB -> B_6_29_0 , & _rtB -> SampleandHold1 , & _rtDW
-> SampleandHold1 , & _rtZCE -> SampleandHold1 ) ; ssCallAccelRunBlock ( S ,
6 , 38 , SS_CALL_MDL_OUTPUTS ) ; } { real_T * * uBuffer = ( real_T * * ) &
...
-> B_6_39_0 = Copy_of_Comment_1_2_acc_rt_TDelayInterpolate ( tMinusDelay ,
...
-> P_76 , 0 , ( boolean_T ) ( ssIsMinorTimeStep ( S ) && (
ssGetTimeOfLastOutput ( S ) == ssGetT ( S ) ) ) ) ; } _rtB -> B_6_40_0 = _rtB
-> B_6_1_0_m - _rtB -> B_6_39_0 ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Compare_Mode_j
= ( _rtB -> B_6_40_0 <= Copy_of_Comment_1_2_rtC ( S ) -> B_6_5_0 ) ; } _rtB
-> B_6_41_0 = _rtDW -> Compare_Mode_j ; ssCallAccelRunBlock ( S , 6 , 42 ,
...
= Copy_of_Comment_1_2_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , *
...
Copy_of_Comment_1_2_rtC ( S ) -> B_6_4_0 ) ; } _rtB -> B_6_46_0 = _rtDW ->
Compare_Mode_c ; Copy_of_Comment_1_2_SampleIL1 ( S , _rtB -> B_6_46_0 , _rtB
-> B_6_29_0 , & _rtB -> SampleIL2 , & _rtDW -> SampleIL2 , & _rtZCE ->
SampleIL2 ) ; Copy_of_Comment_1_2_SampleIL1 ( S , _rtB -> B_6_41_0 , _rtB ->
B_6_29_0 , & _rtB -> SampleIL3 , & _rtDW -> SampleIL3 , & _rtZCE -> SampleIL3
) ; ssCallAccelRunBlock ( S , 6 , 49 , SS_CALL_MDL_OUTPUTS ) ; } _rtB ->
B_6_50_0 = _rtP -> P_79 * _rtB -> B_6_21_0 ; ssCallAccelRunBlock ( S , 6 , 51
, SS_CALL_MDL_OUTPUTS ) ; isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit !=
0 ) { ssCallAccelRunBlock ( S , 6 , 52 , SS_CALL_MDL_OUTPUTS ) ;
...
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( ssIsMajorTimeStep ( S
) != 0 ) { _rtDW -> Compare_Mode_g = ( _rtB -> B_6_21_0 ==
Copy_of_Comment_1_2_rtC ( S ) -> B_6_0_0 ) ; _rtDW -> Compare_Mode_ji = (
_rtB -> B_6_44_0 == Copy_of_Comment_1_2_rtC ( S ) -> B_6_1_0 ) ; } _rtB ->
B_6_57_0 = _rtDW -> Compare_Mode_g ; _rtB -> B_6_58_0 = _rtDW ->
Compare_Mode_ji ; if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW ->
Compare_Mode_i = ( _rtB -> B_6_39_0 == Copy_of_Comment_1_2_rtC ( S ) ->
B_6_2_0 ) ; } _rtB -> B_6_59_0 = _rtDW -> Compare_Mode_i ;
...
P_84 ; _rtB -> B_6_75_0 = Copy_of_Comment_1_2_acc_rt_TDelayInterpolate (
...
int_T tid ) { B_Copy_of_Comment_1_2_T * _rtB ; P_Copy_of_Comment_1_2_T * _rtP
; _rtP = ( ( P_Copy_of_Comment_1_2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_Copy_of_Comment_1_2_T * ) _ssGetModelBlockIO ( S ) ) ; memcpy ( & _rtB ->
B_6_0_0 [ 0 ] , & _rtP -> P_102 [ 0 ] , 9U * sizeof ( real_T ) ) ; _rtB ->
B_6_1_0_m = _rtP -> P_103 ; _rtB -> B_6_2_0 = _rtP -> P_104 ; _rtB -> B_6_3_0
= _rtP -> P_105 ; _rtB -> B_6_4_0 = _rtP -> P_106 ; _rtB -> B_6_5_0 = _rtP ->
P_107 ; _rtB -> B_6_6_0_c = _rtP -> P_108 ; _rtB -> B_6_7_0_k = _rtP -> P_109
; _rtB -> B_6_8_0_c = _rtP -> P_110 ; _rtB -> B_6_9_0_b = _rtP -> P_111 ;
_rtB -> B_6_10_0_p = _rtP -> P_112 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { real_T * lastU ;
int32_T isHit ; B_Copy_of_Comment_1_2_T * _rtB ; P_Copy_of_Comment_1_2_T *
_rtP ; DW_Copy_of_Comment_1_2_T * _rtDW ; _rtDW = ( (
DW_Copy_of_Comment_1_2_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_Copy_of_Comment_1_2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_Copy_of_Comment_1_2_T * ) _ssGetModelBlockIO ( S ) ) ; isHit =
...
( ! Copy_of_Comment_1_2_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
. Tail ) { if ( ! Copy_of_Comment_1_2_acc_rt_TDelayUpdateTailOrGrowBuf ( &
_rtDW -> TransportDelay_IWORK . CircularBufSize , & _rtDW ->
TransportDelay_IWORK . Tail , & _rtDW -> TransportDelay_IWORK . Head , &
_rtDW -> TransportDelay_IWORK . Last , simTime - _rtP -> P_84 , tBuffer ,
...
static void mdlDerivatives ( SimStruct * S ) { B_Copy_of_Comment_1_2_T * _rtB
; XDot_Copy_of_Comment_1_2_T * _rtXdot ; _rtXdot = ( (
XDot_Copy_of_Comment_1_2_T * ) ssGetdX ( S ) ) ; _rtB = ( (
B_Copy_of_Comment_1_2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_6_183_0 ; _rtXdot -> Integrator_CSTATE_m = _rtB
-> B_6_182_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { B_Copy_of_Comment_1_2_T *
_rtB ; P_Copy_of_Comment_1_2_T * _rtP ; ZCV_Copy_of_Comment_1_2_T * _rtZCSV ;
_rtZCSV = ( ( ZCV_Copy_of_Comment_1_2_T * ) ssGetSolverZcSignalVector ( S ) )
; _rtP = ( ( P_Copy_of_Comment_1_2_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_Copy_of_Comment_1_2_T * ) _ssGetModelBlockIO ( S ) ) ; _rtZCSV ->
Step2_StepTime_ZC = ssGetT ( S ) - _rtP -> P_9 ; _rtZCSV ->
Compare_RelopInput_ZC = _rtB -> B_6_22_0 - Copy_of_Comment_1_2_rtC ( S ) ->
B_6_3_0 ; _rtZCSV -> Saturation_UprLim_ZC = _rtB -> B_6_34_0 - _rtP -> P_73 ;
_rtZCSV -> Saturation_LwrLim_ZC = _rtB -> B_6_34_0 - _rtP -> P_74 ; _rtZCSV
-> RelationalOperator_RelopInput_ZC = _rtB -> B_6_35_0 - _rtB -> B_6_21_0 ;
_rtZCSV -> Compare_RelopInput_ZC_n = _rtB -> B_6_40_0 -
Copy_of_Comment_1_2_rtC ( S ) -> B_6_5_0 ; _rtZCSV -> Compare_RelopInput_ZC_a
= _rtB -> B_6_45_0 - Copy_of_Comment_1_2_rtC ( S ) -> B_6_4_0 ; _rtZCSV ->
Compare_RelopInput_ZC_e = _rtB -> B_6_21_0 - Copy_of_Comment_1_2_rtC ( S ) ->
B_6_0_0 ; _rtZCSV -> Compare_RelopInput_ZC_av = _rtB -> B_6_44_0 -
Copy_of_Comment_1_2_rtC ( S ) -> B_6_1_0 ; _rtZCSV -> Compare_RelopInput_ZC_j
= _rtB -> B_6_39_0 - Copy_of_Comment_1_2_rtC ( S ) -> B_6_2_0 ; _rtZCSV ->
...
, 1641067553U ) ; ssSetChecksumVal ( S , 1 , 49804829U ) ; ssSetChecksumVal (
S , 2 , 2957177251U ) ; ssSetChecksumVal ( S , 3 , 753575546U ) ; { mxArray *
...
S ) != sizeof ( DW_Copy_of_Comment_1_2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_Copy_of_Comment_1_2_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofY ( S ) != sizeof
( ExtY_Copy_of_Comment_1_2_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal ExternalOutputs sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_Copy_of_Comment_1_2_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & Copy_of_Comment_1_2_rtDefaultP ) ; _ssSetConstBlockIO ( S , &
Copy_of_Comment_1_2_rtInvariant ) ; rt_InitInfAndNaN ( sizeof ( real_T ) ) ;
