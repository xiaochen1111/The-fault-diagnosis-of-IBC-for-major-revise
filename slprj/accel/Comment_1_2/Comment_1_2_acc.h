...
#ifndef RTW_HEADER_Comment_1_2_acc_h_
#define RTW_HEADER_Comment_1_2_acc_h_
#include <stddef.h>
#include <float.h>
#include <string.h>
#ifndef Comment_1_2_acc_COMMON_INCLUDES_
#define Comment_1_2_acc_COMMON_INCLUDES_
#include <stdlib.h>
...
#endif
#include "Comment_1_2_acc_types.h"
...
typedef struct { real_T B_1_0_0 ; } B_SampleIL1_Comment_1_2_T ; typedef
struct { int32_T SampleIL1_sysIdxToRun ; int8_T SampleIL1_SubsysRanBC ;
char_T pad_SampleIL1_SubsysRanBC [ 3 ] ; } DW_SampleIL1_Comment_1_2_T ;
typedef struct { real_T SampleIL1_Trig_ZC ; } ZCV_SampleIL1_Comment_1_2_T ;
typedef struct { ZCSigState SampleIL1_Trig_ZCE ; }
ZCE_SampleIL1_Comment_1_2_T ; typedef struct { real_T B_6_1_0 ; real_T
...
char_T pad_B_6_59_0 [ 1 ] ; B_SampleIL1_Comment_1_2_T SampleandHold1 ;
B_SampleIL1_Comment_1_2_T SampleIL4 ; B_SampleIL1_Comment_1_2_T SampleIL3 ;
B_SampleIL1_Comment_1_2_T SampleIL2 ; B_SampleIL1_Comment_1_2_T SampleIL1 ; }
B_Comment_1_2_T ; typedef struct { real_T UnitDelay_DSTATE ; real_T
...
DW_SampleIL1_Comment_1_2_T SampleandHold1 ; DW_SampleIL1_Comment_1_2_T
SampleIL4 ; DW_SampleIL1_Comment_1_2_T SampleIL3 ; DW_SampleIL1_Comment_1_2_T
SampleIL2 ; DW_SampleIL1_Comment_1_2_T SampleIL1 ; } DW_Comment_1_2_T ;
typedef struct { real_T Integrator_CSTATE ; real_T Integrator_CSTATE_m ; }
X_Comment_1_2_T ; typedef struct { real_T Integrator_CSTATE ; real_T
Integrator_CSTATE_m ; } XDot_Comment_1_2_T ; typedef struct { boolean_T
Integrator_CSTATE ; boolean_T Integrator_CSTATE_m ; } XDis_Comment_1_2_T ;
typedef struct { real_T Integrator_CSTATE ; real_T Integrator_CSTATE_m ; }
CStateAbsTol_Comment_1_2_T ; typedef struct { real_T Step2_StepTime_ZC ;
...
ZCV_SampleIL1_Comment_1_2_T SampleandHold1 ; ZCV_SampleIL1_Comment_1_2_T
SampleIL4 ; ZCV_SampleIL1_Comment_1_2_T SampleIL3 ;
ZCV_SampleIL1_Comment_1_2_T SampleIL2 ; ZCV_SampleIL1_Comment_1_2_T SampleIL1
; } ZCV_Comment_1_2_T ; typedef struct { ZCSigState Step2_StepTime_ZCE ;
...
HitCrossing_HitNoOutput_ZCE_l ; ZCE_SampleIL1_Comment_1_2_T SampleandHold1 ;
ZCE_SampleIL1_Comment_1_2_T SampleIL4 ; ZCE_SampleIL1_Comment_1_2_T SampleIL3
; ZCE_SampleIL1_Comment_1_2_T SampleIL2 ; ZCE_SampleIL1_Comment_1_2_T
SampleIL1 ; } PrevZCX_Comment_1_2_T ; typedef struct { const real_T B_6_0_0 ;
const real_T B_6_1_0 ; const real_T B_6_2_0 ; const real_T B_6_3_0 ; const
real_T B_6_4_0 ; const real_T B_6_5_0 ; } ConstB_Comment_1_2_T ;
#define Comment_1_2_rtC(S) ((ConstB_Comment_1_2_T *) _ssGetConstBlockIO(S))
typedef struct { real_T * B_2_2 ; real_T * B_2_3 ; real_T * B_2_4 ; }
ExtY_Comment_1_2_T ; struct P_SampleIL1_Comment_1_2_T_ { real_T P_0 ; } ;
struct P_Comment_1_2_T_ { real_T P_0 ; real_T P_1 ; real_T P_2 ; real_T P_3 ;
...
P_110 ; real_T P_111 ; real_T P_112 ; P_SampleIL1_Comment_1_2_T
SampleandHold1 ; P_SampleIL1_Comment_1_2_T SampleIL4 ;
P_SampleIL1_Comment_1_2_T SampleIL3 ; P_SampleIL1_Comment_1_2_T SampleIL2 ;
P_SampleIL1_Comment_1_2_T SampleIL1 ; } ; extern P_Comment_1_2_T
Comment_1_2_rtDefaultP ; extern const ConstB_Comment_1_2_T
Comment_1_2_rtInvariant ;
#endif
