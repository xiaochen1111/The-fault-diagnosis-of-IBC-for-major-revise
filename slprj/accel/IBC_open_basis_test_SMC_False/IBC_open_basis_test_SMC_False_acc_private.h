...
#ifndef RTW_HEADER_IBC_open_basis_test_SMC_False_acc_private_h_
#define RTW_HEADER_IBC_open_basis_test_SMC_False_acc_private_h_
#include "rtwtypes.h"
...
P_SampleandHold_IBC_open_basis_test_SMC_False_T * localP ) ; void
IBC_open_basis_test_SMC_False_SampleandHold ( SimStruct * S , real_T
rtu_Trigger , real_T rtu_In , B_SampleandHold_IBC_open_basis_test_SMC_False_T
* localB , DW_SampleandHold_IBC_open_basis_test_SMC_False_T * localDW ,
ZCE_SampleandHold_IBC_open_basis_test_SMC_False_T * localZCE ) ;
#endif
