#include "__cf_IBC_MPC_comment_2_5.h"
#include <math.h>
#include "IBC_MPC_comment_2_5_acc.h"
#include "IBC_MPC_comment_2_5_acc_private.h"
#include <stdio.h>
...
#endif
boolean_T IBC_MPC_comment_2_5_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
...
return ( true ) ; } real_T IBC_MPC_comment_2_5_acc_rt_TDelayInterpolate (
...
void IBC_MPC_comment_2_5_SampleIL1_Init ( SimStruct * S ,
B_SampleIL1_IBC_MPC_comment_2_5_T * localB ,
P_SampleIL1_IBC_MPC_comment_2_5_T * localP ) { localB -> B_1_0_0 = localP ->
P_0 ; } void IBC_MPC_comment_2_5_SampleIL1 ( SimStruct * S , boolean_T
rtu_Trigger , real_T rtu_In , B_SampleIL1_IBC_MPC_comment_2_5_T * localB ,
DW_SampleIL1_IBC_MPC_comment_2_5_T * localDW ,
ZCE_SampleIL1_IBC_MPC_comment_2_5_T * localZCE ) { if ( ssIsMajorTimeStep ( S
) != 0 ) { if ( ( ! rtu_Trigger ) && ( localZCE -> SampleIL1_Trig_ZCE !=
ZERO_ZCSIG ) ) { localB -> B_1_0_0 = rtu_In ; localDW ->
SampleIL1_SubsysRanBC = 4 ; } localZCE -> SampleIL1_Trig_ZCE = rtu_Trigger ;
} } void IBC_MPC_comment_2_5_SampleIL1_Term ( SimStruct * const S ) { }
static void mdlOutputs ( SimStruct * S , int_T tid ) { real_T * lastU ;
real_T rtb_B_6_13_0 ; real_T rtb_B_6_2_0 ; int32_T isHit ;
B_IBC_MPC_comment_2_5_T * _rtB ; P_IBC_MPC_comment_2_5_T * _rtP ;
X_IBC_MPC_comment_2_5_T * _rtX ; PrevZCX_IBC_MPC_comment_2_5_T * _rtZCE ;
DW_IBC_MPC_comment_2_5_T * _rtDW ; _rtDW = ( ( DW_IBC_MPC_comment_2_5_T * )
ssGetRootDWork ( S ) ) ; _rtZCE = ( ( PrevZCX_IBC_MPC_comment_2_5_T * )
_ssGetPrevZCSigState ( S ) ) ; _rtX = ( ( X_IBC_MPC_comment_2_5_T * )
ssGetContStates ( S ) ) ; _rtP = ( ( P_IBC_MPC_comment_2_5_T * )
ssGetModelRtp ( S ) ) ; _rtB = ( ( B_IBC_MPC_comment_2_5_T * )
_ssGetModelBlockIO ( S ) ) ; _rtB -> B_6_1_0 = rt_Lookup ( _rtP -> P_7 , 6 ,
ssGetT ( S ) , _rtP -> P_8 ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if (
isHit != 0 ) { _rtDW -> Step2_MODE = ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_9
) ; if ( _rtDW -> Step2_MODE == 1 ) { rtb_B_6_2_0 = _rtP -> P_11 ; } else {
rtb_B_6_2_0 = _rtP -> P_10 ; } if ( ! ( muDoubleScalarAbs ( rtb_B_6_2_0 ) >
_rtP -> P_12 ) ) { if ( muDoubleScalarSign ( rtb_B_6_2_0 ) > _rtP -> P_0 ) {
rtb_B_6_2_0 = _rtB -> B_6_11_0_c ; } else { rtb_B_6_2_0 = _rtB -> B_6_12_0_f
; } } _rtB -> B_6_6_0 = _rtB -> B_6_10_0_p / rtb_B_6_2_0 ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_6_7_0 = _rtDW ->
UnitDelay_DSTATE ; } isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_6_8_0 = _rtB -> B_6_6_0 - _rtB -> B_6_7_0 ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { ssCallAccelRunBlock ( S , 6
, 9 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_6_10_0 = _rtP -> P_62 * _rtB ->
B_6_9_0 [ 9 ] ; _rtB -> B_6_11_0 = _rtP -> P_63 * _rtB -> B_6_9_0 [ 18 ] ;
_rtB -> B_6_12_0 = _rtB -> B_6_19_0 * _rtB -> B_6_10_0 * _rtB -> B_6_11_0 ;
rtb_B_6_13_0 = _rtB -> B_6_1_0_m - _rtB -> B_6_10_0 ; _rtB -> B_6_14_0 = _rtP
-> P_64 * rtb_B_6_13_0 ; } _rtB -> B_6_15_0 = _rtX -> Integrator_CSTATE ;
_rtB -> B_6_16_0 = _rtB -> B_6_14_0 + _rtB -> B_6_15_0 ; if (
ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Saturation_MODE = _rtB -> B_6_16_0
>= _rtP -> P_66 ? 1 : _rtB -> B_6_16_0 > _rtP -> P_67 ? 0 : - 1 ; } _rtB ->
B_6_18_0 = ( _rtDW -> Saturation_MODE == 1 ? _rtP -> P_66 : _rtDW ->
Saturation_MODE == - 1 ? _rtP -> P_67 : _rtB -> B_6_16_0 ) / _rtB ->
B_6_28_0_n ; isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB
-> B_6_20_0 = _rtB -> B_6_21_0 * _rtB -> B_6_11_0 * _rtB -> B_6_1_0_m ; _rtB
-> B_6_22_0 = _rtB -> B_6_23_0 * _rtB -> B_6_10_0 * ( _rtP -> P_68 * _rtB ->
B_6_9_0 [ 10 ] ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 )
{ _rtB -> B_6_25_0 = _rtB -> B_6_10_0 * _rtB -> B_6_10_0 * _rtB -> B_6_14_0_g
* _rtB -> B_6_27_0_m ; } _rtB -> B_6_27_0 = ( ( ( _rtB -> B_6_25_0_g * _rtB
-> B_6_10_0 * _rtB -> B_6_18_0 + _rtB -> B_6_12_0 ) - _rtB -> B_6_20_0 ) -
_rtB -> B_6_22_0 ) / _rtB -> B_6_25_0 + _rtB -> B_6_26_0 ; if (
ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Saturation_MODE_o = _rtB ->
B_6_27_0 >= _rtP -> P_69 ? 1 : _rtB -> B_6_27_0 > _rtP -> P_70 ? 0 : - 1 ; }
_rtB -> B_6_28_0 = _rtDW -> Saturation_MODE_o == 1 ? _rtP -> P_69 : _rtDW ->
Saturation_MODE_o == - 1 ? _rtP -> P_70 : _rtB -> B_6_27_0 ;
...
P_77 ; _rtB -> B_6_43_0 = IBC_MPC_comment_2_5_acc_rt_TDelayInterpolate (
...
IBC_MPC_comment_2_5_acc_rt_TDelayInterpolate ( tMinusDelay , 0.0 , * tBuffer
...
<= IBC_MPC_comment_2_5_rtC ( S ) -> B_6_3_0 ) ; } _rtB -> B_6_48_0 = _rtDW ->
...
IBC_MPC_comment_2_5_SampleIL1 ( S , _rtB -> B_6_48_0 , _rtB -> B_6_11_0 , &
_rtB -> SampleandHold1 , & _rtDW -> SampleandHold1 , & _rtZCE ->
SampleandHold1 ) ; } _rtB -> B_6_52_0 = _rtB -> B_6_4_0 - _rtB -> B_6_43_0 ;
isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if (
ssIsMajorTimeStep ( S ) != 0 ) { _rtDW -> Compare_Mode_d = ( _rtB -> B_6_52_0
<= IBC_MPC_comment_2_5_rtC ( S ) -> B_6_4_0 ) ; } _rtB -> B_6_53_0 = _rtDW ->
Compare_Mode_d ; IBC_MPC_comment_2_5_SampleIL1 ( S , _rtB -> B_6_53_0 , _rtB
-> B_6_11_0 , & _rtB -> SampleIL2 , & _rtDW -> SampleIL2 , & _rtZCE ->
SampleIL2 ) ; } _rtB -> B_6_55_0 = _rtB -> B_6_4_0 - _rtB -> B_6_45_0 ; isHit
= ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { if ( ssIsMajorTimeStep (
S ) != 0 ) { _rtDW -> Compare_Mode_b = ( _rtB -> B_6_55_0 <=
IBC_MPC_comment_2_5_rtC ( S ) -> B_6_5_0 ) ; } _rtB -> B_6_56_0 = _rtDW ->
Compare_Mode_b ; IBC_MPC_comment_2_5_SampleIL1 ( S , _rtB -> B_6_56_0 , _rtB
-> B_6_11_0 , & _rtB -> SampleIL3 , & _rtDW -> SampleIL3 , & _rtZCE ->
...
B_6_41_0 == IBC_MPC_comment_2_5_rtC ( S ) -> B_6_0_0 ) ; _rtDW ->
Compare_Mode_k = ( _rtB -> B_6_43_0 == IBC_MPC_comment_2_5_rtC ( S ) ->
B_6_1_0 ) ; } _rtB -> B_6_63_0 = _rtDW -> Compare_Mode_n ; _rtB -> B_6_64_0 =
_rtDW -> Compare_Mode_k ; if ( ssIsMajorTimeStep ( S ) != 0 ) { _rtDW ->
Compare_Mode_f = ( _rtB -> B_6_45_0 == IBC_MPC_comment_2_5_rtC ( S ) ->
B_6_2_0 ) ; } _rtB -> B_6_65_0 = _rtDW -> Compare_Mode_f ;
ssCallAccelRunBlock ( S , 6 , 66 , SS_CALL_MDL_OUTPUTS ) ;
ssCallAccelRunBlock ( S , 6 , 67 , SS_CALL_MDL_OUTPUTS ) ; }
ssCallAccelRunBlock ( S , 6 , 68 , SS_CALL_MDL_OUTPUTS ) ; _rtB -> B_6_73_0 =
look1_binlxpw ( muDoubleScalarRem ( ssGetT ( S ) - _rtB -> B_6_70_0 , _rtB ->
B_6_6_0_c ) , _rtP -> P_82 , _rtP -> P_81 , 2U ) ; _rtB -> B_6_78_0 =
look1_binlxpw ( muDoubleScalarRem ( ssGetT ( S ) - _rtB -> B_6_75_0 , _rtB ->
B_6_7_0_k ) , _rtP -> P_84 , _rtP -> P_83 , 2U ) ; { real_T * * uBuffer = (
...
P_85 ; _rtB -> B_6_79_0 = IBC_MPC_comment_2_5_acc_rt_TDelayInterpolate (
...
( S ) == ssGetT ( S ) ) ) ) ; } _rtB -> B_6_84_0 = look1_binlxpw (
muDoubleScalarRem ( ssGetT ( S ) - _rtB -> B_6_81_0 , _rtB -> B_6_8_0_c ) ,
_rtP -> P_88 , _rtP -> P_87 , 2U ) ; ssCallAccelRunBlock ( S , 6 , 85 ,
SS_CALL_MDL_OUTPUTS ) ; isHit = ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0
) { _rtB -> B_6_107_0 = _rtB -> B_6_42_0 ; _rtB -> B_6_117_0 = _rtB ->
B_6_44_0 ; _rtDW -> Step_MODE = ( ssGetTaskTime ( S , 1 ) >= _rtP -> P_89 ) ;
if ( _rtDW -> Step_MODE == 1 ) { rtb_B_6_2_0 = _rtP -> P_91 ; } else {
rtb_B_6_2_0 = _rtP -> P_90 ; } if ( rtb_B_6_2_0 > _rtP -> P_92 ) { _rtB ->
B_6_137_0 = _rtB -> B_6_46_0 ; } else { _rtB -> B_6_137_0 = _rtB -> B_6_9_0_b
; } } if ( ( _rtDW -> TimeStampA >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB
>= ssGetT ( S ) ) ) { _rtB -> B_6_141_0 = 0.0 ; } else { rtb_B_6_2_0 = _rtDW
...
else { if ( _rtDW -> TimeStampA >= ssGetT ( S ) ) { rtb_B_6_2_0 = _rtDW ->
TimeStampB ; lastU = & _rtDW -> LastUAtTimeB ; } } _rtB -> B_6_141_0 = ( _rtB
-> B_6_1_0 - * lastU ) / ( ssGetT ( S ) - rtb_B_6_2_0 ) ; } isHit =
ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) { _rtB -> B_6_143_0 = _rtP ->
P_94 * _rtB -> B_6_9_0 [ 15 ] ; _rtB -> B_6_144_0 = _rtP -> P_95 * _rtB ->
B_6_9_0 [ 16 ] ; _rtB -> B_6_145_0 = _rtP -> P_96 * _rtB -> B_6_9_0 [ 17 ] ;
_rtB -> B_6_146_0 = _rtP -> P_97 * _rtB -> B_6_9_0 [ 14 ] ;
ssCallAccelRunBlock ( S , 6 , 147 , SS_CALL_MDL_OUTPUTS ) ; } _rtB ->
B_6_161_0 = rt_Lookup ( _rtP -> P_98 , 6 , ssGetT ( S ) , _rtP -> P_99 ) ; if
( ( _rtDW -> TimeStampA_b >= ssGetT ( S ) ) && ( _rtDW -> TimeStampB_f >=
ssGetT ( S ) ) ) { _rtB -> B_6_162_0 = 0.0 ; } else { rtb_B_6_2_0 = _rtDW ->
TimeStampA_b ; lastU = & _rtDW -> LastUAtTimeA_f ; if ( _rtDW -> TimeStampA_b
< _rtDW -> TimeStampB_f ) { if ( _rtDW -> TimeStampB_f < ssGetT ( S ) ) {
rtb_B_6_2_0 = _rtDW -> TimeStampB_f ; lastU = & _rtDW -> LastUAtTimeB_e ; } }
else { if ( _rtDW -> TimeStampA_b >= ssGetT ( S ) ) { rtb_B_6_2_0 = _rtDW ->
TimeStampB_f ; lastU = & _rtDW -> LastUAtTimeB_e ; } } _rtB -> B_6_162_0 = (
_rtB -> B_6_161_0 - * lastU ) / ( ssGetT ( S ) - rtb_B_6_2_0 ) ; } isHit =
ssIsSampleHit ( S , 1 , 0 ) ; if ( isHit != 0 ) { ssCallAccelRunBlock ( S , 6
, 185 , SS_CALL_MDL_OUTPUTS ) ; IBC_MPC_comment_2_5_SampleIL1 ( S , _rtB ->
B_6_48_0 , _rtB -> B_6_11_0 , & _rtB -> SampleIL1 , & _rtDW -> SampleIL1 , &
_rtZCE -> SampleIL1 ) ; IBC_MPC_comment_2_5_SampleIL1 ( S , _rtB -> B_6_48_0
, _rtB -> B_6_10_0 , & _rtB -> SampleIL4 , & _rtDW -> SampleIL4 , & _rtZCE ->
SampleIL4 ) ; } isHit = ssIsSampleHit ( S , 2 , 0 ) ; if ( isHit != 0 ) {
_rtB -> B_6_188_0 = _rtP -> P_101 * rtb_B_6_13_0 ; } UNUSED_PARAMETER ( tid )
; } static void mdlOutputsTID3 ( SimStruct * S , int_T tid ) { real_T
rtb_B_6_13_0 ; B_IBC_MPC_comment_2_5_T * _rtB ; P_IBC_MPC_comment_2_5_T *
_rtP ; _rtP = ( ( P_IBC_MPC_comment_2_5_T * ) ssGetModelRtp ( S ) ) ; _rtB =
( ( B_IBC_MPC_comment_2_5_T * ) _ssGetModelBlockIO ( S ) ) ; memcpy ( & _rtB
...
int32_T isHit ; B_IBC_MPC_comment_2_5_T * _rtB ; P_IBC_MPC_comment_2_5_T *
_rtP ; DW_IBC_MPC_comment_2_5_T * _rtDW ; _rtDW = ( (
DW_IBC_MPC_comment_2_5_T * ) ssGetRootDWork ( S ) ) ; _rtP = ( (
P_IBC_MPC_comment_2_5_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_IBC_MPC_comment_2_5_T * ) _ssGetModelBlockIO ( S ) ) ; isHit =
...
( ! IBC_MPC_comment_2_5_acc_rt_TDelayUpdateTailOrGrowBuf ( & _rtDW ->
...
. Tail ) { if ( ! IBC_MPC_comment_2_5_acc_rt_TDelayUpdateTailOrGrowBuf ( &
...
TransportDelay_IWORK . Head ] = _rtB -> B_6_84_0 ; } if ( _rtDW -> TimeStampA
...
lastU = & _rtDW -> LastUAtTimeA_f ; } else if ( _rtDW -> TimeStampB_f == (
rtInf ) ) { _rtDW -> TimeStampB_f = ssGetT ( S ) ; lastU = & _rtDW ->
LastUAtTimeB_e ; } else if ( _rtDW -> TimeStampA_b < _rtDW -> TimeStampB_f )
{ _rtDW -> TimeStampA_b = ssGetT ( S ) ; lastU = & _rtDW -> LastUAtTimeA_f ;
} else { _rtDW -> TimeStampB_f = ssGetT ( S ) ; lastU = & _rtDW ->
LastUAtTimeB_e ; } * lastU = _rtB -> B_6_161_0 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
static void mdlUpdateTID3 ( SimStruct * S , int_T tid ) { UNUSED_PARAMETER (
tid ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { B_IBC_MPC_comment_2_5_T * _rtB
; XDot_IBC_MPC_comment_2_5_T * _rtXdot ; _rtXdot = ( (
XDot_IBC_MPC_comment_2_5_T * ) ssGetdX ( S ) ) ; _rtB = ( (
B_IBC_MPC_comment_2_5_T * ) _ssGetModelBlockIO ( S ) ) ; _rtXdot ->
Integrator_CSTATE = _rtB -> B_6_188_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { B_IBC_MPC_comment_2_5_T *
_rtB ; P_IBC_MPC_comment_2_5_T * _rtP ; ZCV_IBC_MPC_comment_2_5_T * _rtZCSV ;
_rtZCSV = ( ( ZCV_IBC_MPC_comment_2_5_T * ) ssGetSolverZcSignalVector ( S ) )
; _rtP = ( ( P_IBC_MPC_comment_2_5_T * ) ssGetModelRtp ( S ) ) ; _rtB = ( (
B_IBC_MPC_comment_2_5_T * ) _ssGetModelBlockIO ( S ) ) ; _rtZCSV ->
...
IBC_MPC_comment_2_5_rtC ( S ) -> B_6_3_0 ; _rtZCSV -> Compare_RelopInput_ZC_l
= _rtB -> B_6_52_0 - IBC_MPC_comment_2_5_rtC ( S ) -> B_6_4_0 ; _rtZCSV ->
Compare_RelopInput_ZC_g = _rtB -> B_6_55_0 - IBC_MPC_comment_2_5_rtC ( S ) ->
B_6_5_0 ; _rtZCSV -> Compare_RelopInput_ZC_n = _rtB -> B_6_41_0 -
IBC_MPC_comment_2_5_rtC ( S ) -> B_6_0_0 ; _rtZCSV -> Compare_RelopInput_ZC_a
= _rtB -> B_6_43_0 - IBC_MPC_comment_2_5_rtC ( S ) -> B_6_1_0 ; _rtZCSV ->
Compare_RelopInput_ZC_b = _rtB -> B_6_45_0 - IBC_MPC_comment_2_5_rtC ( S ) ->
...
1796138633U ) ; ssSetChecksumVal ( S , 1 , 2315078112U ) ; ssSetChecksumVal (
S , 2 , 999860665U ) ; ssSetChecksumVal ( S , 3 , 2964284282U ) ; { mxArray *
...
S ) != sizeof ( DW_IBC_MPC_comment_2_5_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_IBC_MPC_comment_2_5_T ) ) { ssSetErrorStatus ( S ,
"Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_IBC_MPC_comment_2_5_T ) ) { static char msg [ 256 ] ; sprintf ( msg ,
"Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & IBC_MPC_comment_2_5_rtDefaultP ) ; _ssSetConstBlockIO ( S , &
IBC_MPC_comment_2_5_rtInvariant ) ; rt_InitInfAndNaN ( sizeof ( real_T ) ) ;
