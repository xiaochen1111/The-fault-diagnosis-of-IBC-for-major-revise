...
#endif
boolean_T
C_fault_detection_under_varing_input_voltage_acc_rt_TDelayUpdateTailOrGrowBuf
...
C_fault_detection_under_varing_input_voltage_acc_rt_TDelayInterpolate (
...
void C_fault_detection_under_varing_input_voltage_SampleIL1_Init ( SimStruct
* S , B_SampleIL1_C_fault_detection_under_varing_input_voltage_T * localB ,
P_SampleIL1_C_fault_detection_under_varing_input_voltage_T * localP ) {
localB -> B_1_0_0 = localP -> P_0 ; } void
C_fault_detection_under_varing_input_voltage_SampleIL1 ( SimStruct * S ,
boolean_T rtu_Trigger , real_T rtu_In ,
B_SampleIL1_C_fault_detection_under_varing_input_voltage_T * localB ,
DW_SampleIL1_C_fault_detection_under_varing_input_voltage_T * localDW ,
ZCE_SampleIL1_C_fault_detection_under_varing_input_voltage_T * localZCE ) {
...
} } void C_fault_detection_under_varing_input_voltage_SampleIL1_Term (
SimStruct * const S ) { } static void mdlOutputs ( SimStruct * S , int_T tid
) { real_T * lastU ; real_T rtb_B_6_25_0 ; real_T rtb_B_6_2_0 ; boolean_T
rtb_B_6_64_0 ; boolean_T rtb_B_6_63_0 ; int32_T isHit ;
B_C_fault_detection_under_varing_input_voltage_T * _rtB ;
P_C_fault_detection_under_varing_input_voltage_T * _rtP ;
X_C_fault_detection_under_varing_input_voltage_T * _rtX ;
PrevZCX_C_fault_detection_under_varing_input_voltage_T * _rtZCE ;
DW_C_fault_detection_under_varing_input_voltage_T * _rtDW ; _rtDW = ( (
DW_C_fault_detection_under_varing_input_voltage_T * ) ssGetRootDWork ( S ) )
; _rtZCE = ( ( PrevZCX_C_fault_detection_under_varing_input_voltage_T * )
_ssGetPrevZCSigState ( S ) ) ; _rtX = ( (
X_C_fault_detection_under_varing_input_voltage_T * ) ssGetContStates ( S ) )
; _rtP = ( ( P_C_fault_detection_under_varing_input_voltage_T * )
ssGetModelRtp ( S ) ) ; _rtB = ( (
B_C_fault_detection_under_varing_input_voltage_T * ) _ssGetModelBlockIO ( S )
...
B_6_22_0 <= C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_3_0
) ; } _rtB -> B_6_23_0 = _rtDW -> Compare_Mode ;
C_fault_detection_under_varing_input_voltage_SampleIL1 ( S , _rtB -> B_6_23_0
...
C_fault_detection_under_varing_input_voltage_SampleIL1 ( S , _rtB -> B_6_23_0
, _rtB -> B_6_29_0 , & _rtB -> SampleandHold1 , & _rtDW -> SampleandHold1 , &
_rtZCE -> SampleandHold1 ) ; ssCallAccelRunBlock ( S , 6 , 38 ,
...
ssGetT ( S ) ; real_T tMinusDelay = simTime - _rtP -> P_75 ; _rtB -> B_6_39_0
= C_fault_detection_under_varing_input_voltage_acc_rt_TDelayInterpolate (
...
= ( _rtB -> B_6_40_0 <= C_fault_detection_under_varing_input_voltage_rtC ( S
...
= ( _rtB -> B_6_45_0 <= C_fault_detection_under_varing_input_voltage_rtC ( S
) -> B_6_4_0 ) ; } _rtB -> B_6_46_0 = _rtDW -> Compare_Mode_c ;
C_fault_detection_under_varing_input_voltage_SampleIL1 ( S , _rtB -> B_6_46_0
, _rtB -> B_6_29_0 , & _rtB -> SampleIL2 , & _rtDW -> SampleIL2 , & _rtZCE ->
SampleIL2 ) ; C_fault_detection_under_varing_input_voltage_SampleIL1 ( S ,
_rtB -> B_6_41_0 , _rtB -> B_6_29_0 , & _rtB -> SampleIL3 , & _rtDW ->
SampleIL3 , & _rtZCE -> SampleIL3 ) ; ssCallAccelRunBlock ( S , 6 , 49 ,
...
B_6_21_0 == C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_0_0
) ; _rtDW -> Compare_Mode_ji = ( _rtB -> B_6_44_0 ==
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_1_0 ) ; } _rtB
...
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_2_0 ) ; } _rtB
...
if ( isHit != 0 ) { _rtB -> B_6_133_0 = _rtP -> P_93 * _rtB -> B_6_9_0 [ 14 ]
; _rtB -> B_6_134_0 = _rtP -> P_94 * _rtB -> B_6_9_0 [ 15 ] ; _rtB ->
B_6_135_0 = _rtP -> P_95 * _rtB -> B_6_9_0 [ 16 ] ; _rtB -> B_6_136_0 = _rtP
-> P_96 * _rtB -> B_6_9_0 [ 13 ] ; ssCallAccelRunBlock ( S , 6 , 137 ,
...
int_T tid ) { B_C_fault_detection_under_varing_input_voltage_T * _rtB ;
P_C_fault_detection_under_varing_input_voltage_T * _rtP ; _rtP = ( (
P_C_fault_detection_under_varing_input_voltage_T * ) ssGetModelRtp ( S ) ) ;
_rtB = ( ( B_C_fault_detection_under_varing_input_voltage_T * )
...
int32_T isHit ; B_C_fault_detection_under_varing_input_voltage_T * _rtB ;
P_C_fault_detection_under_varing_input_voltage_T * _rtP ;
DW_C_fault_detection_under_varing_input_voltage_T * _rtDW ; _rtDW = ( (
DW_C_fault_detection_under_varing_input_voltage_T * ) ssGetRootDWork ( S ) )
; _rtP = ( ( P_C_fault_detection_under_varing_input_voltage_T * )
...
B_C_fault_detection_under_varing_input_voltage_T * _rtB ;
XDot_C_fault_detection_under_varing_input_voltage_T * _rtXdot ; _rtXdot = ( (
XDot_C_fault_detection_under_varing_input_voltage_T * ) ssGetdX ( S ) ) ;
_rtB = ( ( B_C_fault_detection_under_varing_input_voltage_T * )
_ssGetModelBlockIO ( S ) ) ; _rtXdot -> Integrator_CSTATE = _rtB -> B_6_183_0
; _rtXdot -> Integrator_CSTATE_m = _rtB -> B_6_182_0 ; }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) {
B_C_fault_detection_under_varing_input_voltage_T * _rtB ;
P_C_fault_detection_under_varing_input_voltage_T * _rtP ;
ZCV_C_fault_detection_under_varing_input_voltage_T * _rtZCSV ; _rtZCSV = ( (
ZCV_C_fault_detection_under_varing_input_voltage_T * )
...
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_3_0 ; _rtZCSV
...
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_5_0 ; _rtZCSV
-> Compare_RelopInput_ZC_a = _rtB -> B_6_45_0 -
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_4_0 ; _rtZCSV
-> Compare_RelopInput_ZC_e = _rtB -> B_6_21_0 -
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_0_0 ; _rtZCSV
-> Compare_RelopInput_ZC_av = _rtB -> B_6_44_0 -
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_1_0 ; _rtZCSV
-> Compare_RelopInput_ZC_j = _rtB -> B_6_39_0 -
C_fault_detection_under_varing_input_voltage_rtC ( S ) -> B_6_2_0 ; _rtZCSV
...
, 3216940604U ) ; ssSetChecksumVal ( S , 1 , 1705527454U ) ; ssSetChecksumVal
( S , 2 , 1610609081U ) ; ssSetChecksumVal ( S , 3 , 3778559774U ) ; {
...
( S ) != sizeof ( DW_C_fault_detection_under_varing_input_voltage_T ) ) {
ssSetErrorStatus ( S , "Unexpected error: Internal DWork sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofGlobalBlockIO ( S
) != sizeof ( B_C_fault_detection_under_varing_input_voltage_T ) ) {
ssSetErrorStatus ( S , "Unexpected error: Internal BlockIO sizes do "
"not match for accelerator mex file." ) ; } if ( ssGetSizeofY ( S ) != sizeof
( ExtY_C_fault_detection_under_varing_input_voltage_T ) ) { static char msg [
256 ] ; sprintf ( msg ,
"Unexpected error: Internal ExternalOutputs sizes do "
"not match for accelerator mex file." ) ; } { int ssSizeofParams ;
ssGetSizeofParams ( S , & ssSizeofParams ) ; if ( ssSizeofParams != sizeof (
P_C_fault_detection_under_varing_input_voltage_T ) ) { static char msg [ 256
] ; sprintf ( msg , "Unexpected error: Internal Parameters sizes do "
"not match for accelerator mex file." ) ; } } _ssSetModelRtp ( S , ( real_T *
) & C_fault_detection_under_varing_input_voltage_rtDefaultP ) ;
_ssSetConstBlockIO ( S , &
C_fault_detection_under_varing_input_voltage_rtInvariant ) ; rt_InitInfAndNaN
